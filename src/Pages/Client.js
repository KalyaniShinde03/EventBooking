                        ...
                        <div className='card-body'>
                            ...
                            <div className='row'>
                                <div className='col-2 pt-2'>
                                    ...
                                    {ClientObj.clientId == 0 && <button className='btn btn-sm btn-success' onClick={SaveClient}>Save</button>}
                                    {ClientObj.clientId !== 0 && <button className='btn btn-sm btn-warning' onClick={UpdateClient}>Update</button>}

                                </div>
                                <div className='col-2 pt-2'>
                                <button className='btn btn-sm btn-secondary' onClick={OnResetForm}>Reset</button>
