...
export const GET_EVENT = "GetAllEvents";
export const ADD_EVENTS ="CreateEvent";
export const EDIT_EVENTS ="GetEventById?id=";
export const DELETE_EVENTS ="DeleteEventById?id="
